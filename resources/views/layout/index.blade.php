...
<head>
    ...
    <title>@yield('title') - Dashboard Coffe Shop</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="d-none d-md-inline">Faiq</span>
                    </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashboard.pelanggan') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashboard.coffe') }}" class="nav-link">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Mencari setiap tautan di dalam menu
            $('.nav-sidebar a').each(function() {
                var linkUrl = $(this).attr('href');

                // Memeriksa apakah URL saat ini cocok dengan URL tautan
